...
export function PitchingNinjaBadge() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="inline-flex h-[29px] w-[84px] items-center overflow-hidden bg-black transition-opacity duration-150 hover:opacity-75 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
