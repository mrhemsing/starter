...
export default function Loading() {
  return (
    <RouteLoadingShell route="upcoming" active="upcoming" title="Upcoming Matchups" description="One card per game, ranked by starter form and matchup context." controls="upcoming" layout="upcoming">
