    ...
    <main className="min-h-screen bg-[#08080a] text-zinc-100">
      ...
      <HomeLiveBoardProvider initialBoard={homeTickerBoard} today={today}>
        <section className="relative overflow-hidden px-4 pb-6 pt-6 sm:px-6 lg:px-8">
          ...
          <div className="absolute inset-x-0 top-0 h-[520px] overflow-hidden opacity-[0.58] saturate-[0.92] sm:h-[440px] sm:opacity-[0.44] lg:h-[380px] lg:opacity-100" aria-hidden="true" data-responsive-check="home-header-background">
            <Image
