  ...
  return (
    <main className="min-h-screen bg-[#08080a] text-zinc-100">
      <section className="relative overflow-hidden px-4 pb-6 pt-6 sm:px-6 lg:px-8">
        ...
        <div
          className="absolute inset-x-0 top-0 h-[755px] translate-x-[8%] bg-no-repeat opacity-100 saturate-[0.92] sm:hidden"
          style={{
        ...
        />
        <div
          className="absolute inset-x-0 top-0 hidden h-[647px] bg-no-repeat opacity-100 saturate-[0.92] sm:block lg:h-[590px]"
          style={{
