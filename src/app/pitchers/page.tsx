...
export const metadata = {
  title: "Pitcher Directory | Front Five",
  description: "Searchable directory of qualified starting pitchers with links to Front Five form pages.",
};
    ...
    <main className="min-h-screen bg-[#08080a] px-4 py-8 text-zinc-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mt-6 border-b border-white/10 pb-8">
          ...
          <h1 className="mt-3 font-serif text-5xl font-black leading-none text-zinc-50 sm:text-6xl">Pitchers</h1>
