...
const cronRoute = await readFile("src/app/api/cron/slate-sync/route.ts", "utf8");
...
assert(cronRoute.includes("logRecentSettledSlateGaps"), "the hourly slate-sync cron must run the settled-slate integrity check");
