...
assert(upcomingPage.includes('className="mt-3 flex max-w-full flex-nowrap items-center gap-2 overflow-x-auto rounded-full border border-white/10 bg-[#101014]/75 p-2"'), "Upcoming controls must render surfaced toggles directly below the range tabs on one line");
