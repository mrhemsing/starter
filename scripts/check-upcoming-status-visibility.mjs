...
assert(upcomingPage.includes('className="mt-3 flex flex-wrap items-end gap-3 rounded border border-white/10 bg-[#101014] p-3"'), "Upcoming controls must render surfaced toggles directly below the range tabs");
