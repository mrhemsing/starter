...
assert(simpleBoard.includes("data-simple-ballpark") && simpleBoard.includes("data-simple-ballpark-source={game.park}") && simpleBoard.includes("formatSimpleBallpark(game.park)") && simpleBoard.includes('return trimmed.length > 0 ? trimmed.toUpperCase() : "VENUE TBD";'), "Simple card headers must render the game ballpark next to first pitch.");
