...
assert(simpleBoard.includes("hasQualifiedStarterFormSample(starter) ? starter.tier ?? null : null") && simpleBoard.includes('data-simple-form-chip-source={formBand ? "heat-band" : starter.formStatus === "ok" ? "limited-sample" : starter.formStatus}'), "Simple cards must render limited-sample arms as neutral LTD whisper lines, not FORM pseudo-bands.");
