...
assert(simpleBoard.includes('data-simple-card-rank-tone={rank === 1 && hasNamedStarterMatchup ? "lead" : "muted"}') && simpleBoard.includes('rank === 1 && hasNamedStarterMatchup ? "text-white" : "text-zinc-400"'), "Simple header must render only the #1 rank in white while all other ranks remain gray.");
