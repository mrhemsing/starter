...
assert(simpleBoard.includes("data-simple-confidence-chip={game.watchScoreConfidence}") && simpleBoard.includes("mx-auto mt-2 inline-flex"), "Simple confidence chip must keep a clear vertical gap below the watch score.");
