...
assert(simpleBoard.includes("starterHeatColor") && simpleBoard.includes("data-simple-heat-accent") && simpleBoard.includes("data-simple-form-chip-color={heatColor}") && simpleBoard.includes("HEAT_BANDS.find"), "Simple starter panels must separate team color from shared heat-band chip/accent colors.");
