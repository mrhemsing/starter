...
assert(simpleBoard.includes("data-simple-vs-composition") && simpleBoard.includes("data-simple-vs-seam") && simpleBoard.includes("simpleVsGradient(awayPanelColor, homePanelColor)") && simpleBoard.includes('data-simple-vs-gradient-source="heat-band"') && simpleBoard.includes("data-simple-score-column"), "Desktop Simple cards must compose away and home heat-band gradients into one VS card behind the score.");
...
assert(simpleBoard.includes("data-simple-starter-frame") && simpleBoard.includes("data-simple-starter-panel-color={panelColor}") && simpleBoard.includes('data-simple-starter-panel-source="heat-band"') && simpleBoard.includes("data-simple-starter-nameplate"), "Simple starters must render baseball-card style portrait frames with heat-band colored panels and nameplates.");
assert(simpleBoard.includes('data-simple-starter-nameplate-source="team-color"') && simpleBoard.includes("simpleNameplateGradient(teamColor, align)"), "Simple starter nameplate stripe must stay team-colored.");
assert(simpleBoard.includes('data-simple-starter-card-back-source="heat-band"') && simpleBoard.includes("simpleStarterCardBackGradient(panelColor, align)"), "Simple starter bottom stat bar must use the heat-band color.");
...
assert(simpleBoard.includes("const SIMPLE_EVEN_PANEL_COLOR") && simpleBoard.includes("starterHeatPanelColor") && simpleBoard.includes("data-simple-starter-panel-source=\"heat-band\"") && simpleBoard.includes("data-simple-form-chip-color={heatColor}") && simpleBoard.includes("HEAT_BANDS.find"), "Simple starter panels must use shared heat-band color tokens for the large panel surface.");
